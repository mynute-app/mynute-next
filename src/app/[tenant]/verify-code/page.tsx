...
import { VerifyCodeForm } from "@/app/auth/verify-code/_components/verify-code-form";
import { getTenantCompanyForAuthPage } from "@/lib/tenant-auth-page";

export default async function TenantVerifyCodePage({
  params,
}: {
        ...
        <div className="flex flex-1 items-center justify-center py-4">
          <div className="w-full max-w-xs space-y-4">
            <div className="text-center">
              <h2 className="text-lg font-semibold">Verificacao de codigo</h2>
              <p className="text-sm text-muted-foreground">
                Insira o codigo que enviamos para seu email.
              </p>
            </div>
