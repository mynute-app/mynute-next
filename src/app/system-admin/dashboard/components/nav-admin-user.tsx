    ...
    <DropdownMenu>
      ...
      >
        <DropdownMenuLabel className="p-0 font-normal">
          <div className="flex items-center gap-2 px-2 py-2 text-left text-sm">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-xs text-primary/60">{displayEmail}</p>
            </div>
          </div>
        </DropdownMenuLabel>
        <DropdownMenuItem asChild className="cursor-pointer">
          <Link href="/system-admin/dashboard/config/account">
        ...
        <DropdownMenuItem
          ...
          onClick={() => signOut({ callbackUrl: "/auth/system-admin" })}
        >
